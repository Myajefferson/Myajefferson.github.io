...
### Installing Your Liabrary into an Extrenal Project

To install your libraru into another project:

1. In the terminal 'cd' into te project
2. Run 'npm install -g bower' 
3. Run 'bower install --save https://github.com/Myajefferson/GamingQueen.git"
